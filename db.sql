...
INSERT INTO emprunter (date_emprunt, date_retour_prevue, date_reelle) VALUES
('2023-01-01', '2023-01-15', '2023-01-12'),
('2023-02-01', '2023-02-15', '2023-02-12'),
('2023-03-01', '2023-03-15', '2023-03-12'),
('2023-04-01', '2023-04-15', '2023-04-12'),
('2023-05-01', '2023-05-15', '2023-05-12'),
('2023-06-01', '2023-06-15', '2023-06-12'),
('2023-07-01', '2023-07-15', '2023-07-12'),
('2023-08-01', '2023-08-15', '2023-08-12'),
('2023-09-01', '2023-09-15', '2023-09-12'),
('2023-10-01', '2023-10-15', '2023-10-12'),
('2023-11-01', '2023-11-15', '2023-11-12'),
('2023-12-01', '2023-12-15', '2023-12-12'),
('2024-01-01', '2024-01-15', '2024-01-12'),
('2024-02-01', '2024-02-15', '2024-02-12'),
('2024-03-01', '2024-03-15', '2024-03-12'),
('2024-04-01', '2024-04-15', '2024-04-12'),
('2024-05-01', '2024-05-15', '2024-05-12'),
('2024-06-01', '2024-06-15', '2024-06-12'),
('2024-07-01', '2024-07-15', '2024-07-12'),
('2024-08-01', '2024-08-15', '2024-08-12');

INSERT INTO abonnement (type_abonnement, date_debut, date_fin) VALUES
('Mensuel', '2023-01-01', '2023-01-31'),
('Annuel', '2023-02-01', '2024-01-31'),
('Mensuel', '2023-03-01', '2023-03-31'),
('Mensuel', '2023-04-01', '2023-04-30'),
('Annuel', '2023-05-01', '2024-04-30'),
('Mensuel', '2023-06-01', '2023-06-30'),
('Annuel', '2023-07-01', '2024-06-30'),
('Mensuel', '2023-08-01', '2023-08-31'),
('Mensuel', '2023-09-01', '2023-09-30'),
('Annuel', '2023-10-01', '2024-09-30'),
('Mensuel', '2023-11-01', '2023-11-30'),
('Annuel', '2023-12-01', '2024-11-30'),
('Mensuel', '2024-01-01', '2024-01-31'),
('Annuel', '2024-02-01', '2025-01-31'),
('Mensuel', '2024-03-01', '2024-03-31'),
('Mensuel', '2024-04-01', '2024-04-30'),
('Annuel', '2024-05-01', '2025-04-30'),
('Mensuel', '2024-06-01', '2024-06-30'),
('Annuel', '2024-07-01', '2025-06-30'),
('Mensuel', '2024-08-01', '2024-08-31');

INSERT INTO tournoi (nom_tournoi, date_tournoi, recompenses) VALUES
('Tournoi Action', '2023-03-01', '1000$'),
('Tournoi RPG', '2023-04-15', '500$'),
('Tournoi Adventure', '2023-05-10', '800$'),
('Tournoi Shooter', '2023-06-05', '1200$'),
('Tournoi Puzzle', '2023-07-20', '300$'),
('Tournoi Sports', '2023-08-25', '1000$'),
('Tournoi Simulation', '2023-09-15', '700$'),
('Tournoi Horror', '2023-10-10', '900$'),
('Tournoi RPG Elite', '2023-11-01', '1500$'),
('Tournoi Ultimate', '2023-12-25', '2000$'),
('Tournoi Next Gen', '2024-01-20', '1100$'),
('Tournoi Challenger', '2024-02-15', '950$'),
('Tournoi Legends', '2024-03-10', '1300$'),
('Tournoi Extreme', '2024-04-05', '1600$'),
('Tournoi Classic', '2024-05-15', '400$'),
('Tournoi Rivals', '2024-06-30', '1000$'),
('Tournoi Master', '2024-07-25', '1800$'),
('Tournoi Pro', '2024-08-10', '1400$'),
('Tournoi Open', '2024-09-05', '500$'),
('Tournoi Grand', '2024-10-01', '2000$');

INSERT INTO participer (score, rang_final) VALUES
(89.5, 1),
(76.0, 2),
(92.3, 1),
(68.9, 3),
